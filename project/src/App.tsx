...
import { Package, Bell, DollarSign, Settings, Users, ShoppingBag, Cloud, PenTool as Tool, Box, Layers, BarChart2 } from 'lucide-react';
...
import { MarketplaceSimulator } from './pages/MarketplaceSimulator';
          ...
          <div className="relative">
            <a
              ...
              className={`px-4 py-2 flex items-center justify-between text-gray-300 hover:bg-[#24303a] ${
                currentPage.startsWith('product') || currentPage === 'select-type' || currentPage === 'marketplace-simulator' ? 'bg-[#24303a]' : ''
              }`}
            >
            ...
            {showProductMenu && (
              <div className="bg-[#24303a] py-2">
                ...
                <a
                  href="#"
                  onClick={() => setCurrentPage('marketplace-simulator')}
                  className="px-8 py-2 flex items-center text-gray-300 hover:bg-[#1a242d]"
                >
