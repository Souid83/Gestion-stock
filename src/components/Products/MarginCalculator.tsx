...
// Fonctions exportables pour calcul TVA sur marge
export const TVA_RATE = 1.2;

export function calculateFromSellingPrice(purchase: number, selling: number) {
...
export function calculateFromMarginPercent(purchase: number, percent: number) {
...
export function calculateFromMarginValue(purchase: number, value: number) {
